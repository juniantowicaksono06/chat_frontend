...
<template>
    <div id="login_wrapper" class="py-3">
        <div class="d-flex justify-content-end mr-3 mb-3">
            <nuxt-link to="/login/" class="text-white rounded" id="login_btn">Login</nuxt-link>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <b-form @submit.stop.prevent="onSubmit">
                            <b-form-group>
                                ...
                                <b-form-input v-model="$v.form.username.$model" placeholder="Enter Your Username" :state="validateState('username')"></b-form-input>
                            ...
                            <b-form-group>
                                ...
                                <b-form-input v-model="$v.form.email.$model" placeholder="Enter Your Email" :state="validateState('email')"></b-form-input>
                            ...
                            <b-button block class="rounded" type="submit" variant="primary">Register</b-button>
                        </b-form>
                    </div>
                </div>
            </div>
